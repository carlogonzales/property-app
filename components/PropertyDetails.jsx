import {FaBath, FaBed, FaBookmark, FaPaperPlane, FaRulerCombined, FaShare} from "react-icons/fa";
import {FaCheck, FaLocationDot, FaXmark} from "react-icons/fa6";
        ...
        <main>
                    ...
                    >
                        ...
                        <div className="text-2xl font-bold text-blue-500">
                            {property.rates.nightly? (`$${property.rates.nightly.toLocaleString()}`): (
                                <FaXmark className="text-red-700 mr-2"/>
                            )}
                        </div>
                    </div>
                    <div
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                ...
                >
                    ...
                    <p>
                        <FaRulerCombined className="inline" /> {property.square_feet}{' '} <span className="hidden sm:inline">sqft</span>
                    </p>
                </div>
